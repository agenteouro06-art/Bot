...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🧠 Analizando requerimiento...")
    ...
    await update.message.reply_text(
        "💀 Flujo PRO listo (OCR + Banco + WhatsApp)",
